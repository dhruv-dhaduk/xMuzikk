    ...
    return (
        <div className='w-full'>
            ...
            <div className='flex justify-center mt-10 p-4'>
                <div className='w-full max-w-[50rem]'>
                    <h1 className='mb-2 text-2xl tablet:text-3xl font-bold select-none'>
                        About this site
                    </h1>
                    ...
                    <P>Hello, World !</P>
                    <P>
                        This is xMuzikk : A music player for the web, where you
                        can listen to your favorite music on your phone, tablet
                        or computer. (Some features are still in development and
                        will be available soon.)
                    </P>
                    <P>
                        It is built with React, TailwindCSS, Appwrite and
                        YouTube APIs.
                    </P>
                    <P>
                    ...
                    <P>
                        This is a personal project, and it is only for my
                        learning purposes.
                    </P>
                    <P>
                        All music and songs belongs to YouTube and their
                        respective content creators. And link to original video
                        on YouTube is provided with every music and song.
                    </P>
                </div>
            </div>
            ...
            <div className='flex justify-center p-4'>
                <div className='w-full max-w-[50rem]'>
                    ...
                    <P>
                        Hello, my name is Dhruv Dhaduk. I am a passionate
                        software engineer from Gujarat, India.
                    </P>
                    <P>
                        I am currently studying Computer Engineering at the L.D.
                    ...
                    <ul>
                        ...
                        <li className='select-none indent-8 text-[15px]/[25px]'>
                            LinkedIn :{' '}
                            <a
                                href='https://www.linkedin.com/in/dhruvdhaduk'
                                target='_blank'
                                className='underline select-all whitespace-nowrap'
                            >
                                in/dhruvdhaduk
...
function P({ children, className }) {
    return (
        <p
            className={`mx-1 my-4 text-[15px]/[25px] font-[400] font-sans select-none ${className}`}
        >
            {children}
        </p>
    );
