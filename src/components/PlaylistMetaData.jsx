        ...
        <div className='select-none'>
            ...
            <p className='text-sm line-clamp-1 break-all'>
                {playlist.channelTitle && (
                    <>
                        <span className=''>{playlist.channelTitle}</span>
            ...
            <div className='flex justify-between items-center flex-wrap mt-2'>
                <div className='flex justify-start items-center flex-wrap gap-1'>
                    ...
                    {playlistSavedStatus === false && (
                        <Icon iconSrc={saveHollowIcon} onClick={savePlaylist} />
                    )}
                    ...
                    {playlist.ytId && (
                        <Icon
                            ...
                            onClick={() => {
                                const isConfirmed = window.confirm(
                                    'Open this playlist in YouTube ? '
                                );
                                if (isConfirmed) {
                                    window.open(
                                        `https://www.youtube.com/playlist?list=${playlist.ytId}`
                                    );
                                }
                            }}
                        />
            ...
            {playlist.ytId && (
                <p className='text-xs py-2'>
                    This playlist is copied from youtube. Some songs might be
                    missing or they won't play if they are private or unlisted.
                </p>
            )}
